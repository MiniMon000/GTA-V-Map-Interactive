...
class ZoomPan {
     ...
     */
    scaleUp() {
        const scaleNew = this.calcScaleDelta(1);
        if (scaleNew > this.scaleMax) {
            scaleNew = this.scaleMax; // Set to maximum scale if above
        }
        this.scaleTo(scaleNew);
        return this;
    }
    ...
    scaleDown() {
        ...
        if (scaleNew < this.scaleMin) {
            scaleNew = this.scaleMin; // Set to minimum scale if below
        }
        this.scaleTo(scaleNew);
        return this;
    }
    ...
    scaleWheel(ev) {
        ...
        if (scaleNew < this.scaleMin) {
            scaleNew = this.scaleMin; // Set to minimum scale if below
        } else if (scaleNew > this.scaleMax) {
            scaleNew = this.scaleMax; // Set to maximum scale if above
        }
